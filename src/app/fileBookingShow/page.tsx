          ...
          <table className="w-[1000px] border-collapse border border-gray-300 shadow-md">
            ...
            <thead className="bg-blue-200">
              ...
              <th className="border border-gray-300 px-4 py-2 text-center">#</th>
                ...
                <th className="border border-gray-300 px-4 py-2">Cost (PKR)</th>
              </tr>
            </thead>
            ...
            <tbody>
              {bookings.map((booking: VisaBooking, index) => (
                <tr key={booking._id} className="hover:bg-gray-100">
                  ...
                  <td className="border border-gray-300 px-4 py-2">{booking.prizeForUsers ?? booking.price}</td>
                </tr>
              ))}
            </tbody>
          </table>
