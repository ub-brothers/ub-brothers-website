...
export default function HajjBookings() {
            ...
            <tbody>
              {bookings.map((booking, index) => (
                ...
                <td className="border border-gray-300 px-4 py-2">
                  ...
                  <td className="border border-gray-300 px-4 py-2">{booking.selectedCategory}</td>
                  <td className="border border-gray-300 px-4 py-2">{booking.selectedPrize}</td>
                </tr>
              ))}
            </tbody>
          </table>
